/*
BloomFilter.js v0.0.2 9/12/2025
https://github.com/rawify/BloomFilter.js

Copyright (c) 2025, Robert Eisele (https://raw.org/)
Licensed under the MIT license.
*/
'use strict';(function(t){function m(a,b){const c=Math.LN2;b=Math.ceil(-a*Math.log(b)/(c*c));a=Math.max(1,Math.round(b/a*c));return{bitCount:n(b),hashCount:a}}function p(a,b=0){b>>>=0;const c=a.length>>>0;var e=c>>>2;for(let f=0,g=0;f<e;f++,g+=4){var d=(a[g]|a[g+1]<<8|a[g+2]<<16|a[g+3]<<24)>>>0;d=Math.imul(d,-862048943);d=d<<15|d>>>17;d=Math.imul(d,461845907);b^=d;b=b<<13|b>>>19;b=Math.imul(b,5)+3864292196>>>0}e=0;d=c&3;d===3&&(e^=a[c-3]<<16);d>=2&&(e^=a[c-2]<<8);d>=1&&(e^=a[c-1],e=Math.imul(e,-862048943),
